...
void SolicitarPrecos()
{
    Console.WriteLine("==== Bem Vindo ao VenaParking ====\n");
    Console.WriteLine("Digite o preço de entrada: ");
    PrecoEntrada = Convert.ToDouble(Console.ReadLine());
...
void RemoverVeiculo(List<Veiculo> p_estacionamento)
{
    ...
    if (removido)
    {
        ...
        Console.WriteLine($" {placa} removido com sucesso , valor a pagar = {horas * PrecoPorHora + PrecoEntrada}");
